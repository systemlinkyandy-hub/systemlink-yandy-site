...
from renderer import create_isolated_renderer  # [PHASE C0] renderer失敗をNARU本体から隔離
...
if __name__ == "__main__":
    ...
    write_volume(0.0)
    avatar_engine = create_isolated_renderer()  # [PHASE C0] 失敗してもNARU本体は継続する
    avatar_engine.start()
